...
static void SystemIsolation_ETH_Config(void)
{
  ...
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_4, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_5, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_7, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_10, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_11, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_12, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_13, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_14, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOF, GPIO_PIN_15, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  HAL_GPIO_ConfigPinAttributes(GPIOG, GPIO_PIN_11, GPIO_PIN_SEC | GPIO_PIN_PRIV);
  COB_RIFStage = 1010U;
}
