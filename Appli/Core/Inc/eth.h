...
extern volatile uint32_t COB_ETH_MACISR;
extern volatile uint32_t COB_ETH_MACRXTXSR;
extern volatile uint32_t COB_ETH_MACDR;
...
extern volatile uint32_t COB_ETH_MTLISR;
extern volatile uint32_t COB_ETH_MTLTXQ0OMR;
extern volatile uint32_t COB_ETH_MTLTXQ0DR;
extern volatile uint32_t COB_ETH_MTLQ0ICSR;
extern volatile uint32_t COB_ETH_MTLRXQ0OMR;
extern volatile uint32_t COB_ETH_MTLRXQ0DR;
extern volatile uint32_t COB_ETH_MTLTXQ1OMR;
extern volatile uint32_t COB_ETH_MTLTXQ1DR;
extern volatile uint32_t COB_ETH_MTLQ1ICSR;
extern volatile uint32_t COB_ETH_MTLRXQ1OMR;
extern volatile uint32_t COB_ETH_MTLRXQ1DR;
...
extern volatile uint32_t COB_ETH_DMACTXDLAR;
extern volatile uint32_t COB_ETH_DMACRXDLAR;
extern volatile uint32_t COB_ETH_DMACTXDTPR;
extern volatile uint32_t COB_ETH_DMACRXDTPR;
extern volatile uint32_t COB_ETH_DMACCATXDR;
extern volatile uint32_t COB_ETH_DMACCARXDR;
extern volatile uint32_t COB_ETH_DMACCATXBR;
extern volatile uint32_t COB_ETH_DMACCARXBR;
...
extern volatile uint32_t COB_ETH_PhyIdValid;
extern volatile uint32_t COB_ETH_PhyScanLastAddr;
extern volatile uint32_t COB_ETH_PhyScanFoundID1;
extern volatile uint32_t COB_ETH_PhyScanFoundID2;
extern volatile uint32_t COB_ETH_PHY_SMR;
extern volatile uint32_t COB_ETH_PHY_ID1;
extern volatile uint32_t COB_ETH_PHY_ID2;
